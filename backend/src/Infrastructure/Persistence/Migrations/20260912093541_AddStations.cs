        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PowerKw = table.Column<decimal>(type: "numeric(8,2)", precision: 8, scale: 2, nullable: false),
                    Tariff = table.Column<decimal>(type: "numeric(10,2)", precision: 10, scale: 2, nullable: false),
                    Status = table.Column<string>(type: "text", nullable: false),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false, defaultValueSql: "now()"),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false, defaultValueSql: "now()")
                },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MaintenanceWindows_Chargers_ChargerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MaintenanceWindows_ChargerId",
                table: "MaintenanceWindows",
                column: "ChargerId");

            migrationBuilder.CreateIndex(
                name: "IX_OperatingHours_StationId_DayOfWeek",
                table: "OperatingHours",
                columns: new[] { "StationId", "DayOfWeek" },
                unique: true);
